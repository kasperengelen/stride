...
if(NOT STRIDE_FORCE_NO_PROTOC)
    ...
    message("Forcing Protobuf local build.")
    set(Protobuf_FOUND FALSE)
endif()
#
if(Protobuf_FOUND)
...
if (NOT STRIDE_FORCE_NO_BOOST)
	...
	message("Forcing Boost local build.")
endif()
if (Boost_FOUND)
...
if (NOT STRIDE_FORCE_NO_HDF5)
	...
	message("Forcing HDF5 local build.")
endif()
if(HDF5_FOUND)
