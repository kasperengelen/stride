...
tuple<ptree, unsigned int, double> ScenarioData::Get(string tag)
{
        ...
        const map<string, unsigned int> targets_geopop = {
            {"influenza_a_geopop", 556000U}, {"influenza_b_geopop", 0U},     {"influenza_c_geopop", 5U},
            {"measles_16_geopop", 275000U},  {"measles_26_geopop", 600000U}, {"r0_0_geopop", 1200U},
            {"r0_12_geopop", 39300U},        {"r0_16_geopop", 74500U},       {"r0_4_geopop", 4300U},
            {"r0_8_geopop", 15900U}};
