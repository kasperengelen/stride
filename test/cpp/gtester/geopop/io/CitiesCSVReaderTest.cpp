...
shared_ptr<GeoGrid> getExpectedGeoGrid()
{
        ...
        auto loc1    = make_shared<SimLocation>(11002, 1, Coordinate(4.413545489, 51.2165845), "ANTWERPEN");
        auto loc2    = make_shared<SimLocation>(11007, 1, Coordinate(4.4856299, 51.1966684), "BORSBEEK");
        auto loc3    = make_shared<SimLocation>(11008, 1, Coordinate(4.49419, 51.29227), "BRASSCHAAT");
