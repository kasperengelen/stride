 ...
 */
void MakeGeoGrid(const geopop::GeoGridConfig& , int locCount, int locPop, int daycareCount, int preschoolCount, int schoolCount, int houseHoldCount, int personCount, stride::Population* pop);
