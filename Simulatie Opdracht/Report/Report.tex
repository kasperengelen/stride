...
\paragraph{} For each parameter set listed in table \ref{2_1_regionDiff_tableParamSets}, we ran 1000 simulations.
...
\caption{Plot that compares region A and B with a simulation over 50 days with seeding rate $0.02$.}
\end{figure}
...
\caption{Plot that compares region A and B with a simulation over 300 days with seeding rate $0.02$.}
\end{figure}
...
\paragraph{} We can clearly see that the outbreaks in region A are consistently higher than those in region B.
...
\caption{Plot that compares regionA and B with a simulation over 300 days with seeding rate $0.00000167$.}
\end{figure}
