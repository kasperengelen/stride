...
def getCSVFileName(param_list):
    ...
    return "./data/" + "region{}_stan_r0=11_VC=0.8_SR={}_cnt=100_days={}.csv".format(*param_list)
#ENDFUNCTION
...
def getSVGFileName(param_list, plot_name):
    ...
    return "./figs/" + "region{}_stan_r0=11_VC=0.8_SR={}_cnt=100_days={}_{}.svg".format(*(param_list + [plot_name]))
#ENDFUNCTION

def plot_all(param_lists, to_file=False):
    for param_list in param_lists:
        print("Plotting for parameters (region, seed rate, days): " + str(param_list))
