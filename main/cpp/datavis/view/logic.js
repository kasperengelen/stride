...
/**
 * Determine the distance between the specified
...
/**
 * Determine the radius of a MapCircle based
 * on the size of the population that it represents.
 */
...
/**
 * Create the string representation of a fraction in percentage format
 * with 2 decimals.
 */
...
/**
 * Given a ListModel, a section name and a map that contains
 * information about a population section, this will add the information to the
 * ListModel.
 */
