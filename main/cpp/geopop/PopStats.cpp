...
{
        switch (poolId) {
        case stride::ContactType::Id::Household: return this->m_household;
        case stride::ContactType::Id::K12School: return this->m_k12_school;
        case stride::ContactType::Id::College: return this->m_college;
        case stride::ContactType::Id::Workplace: return this->m_workplace;
        case stride::ContactType::Id::PrimaryCommunity: return this->m_prim_com;
        case stride::ContactType::Id::SecondaryCommunity: return this->m_sec_com;
        case stride::ContactType::Id::Daycare: return this->m_daycare;
        case stride::ContactType::Id::PreSchool: return this->m_preschool;
        }

        throw std::runtime_error{"Error: GetPool called on unknown pool type '" +
                                 stride::ContactType::ToString(poolId) + "' which is not handled "};
}
...
{
        switch (poolId) {
        case stride::ContactType::Id::Household: m_household = std::move(poolStats); break;
        case stride::ContactType::Id::K12School: m_k12_school = std::move(poolStats); break;
        case stride::ContactType::Id::College: m_college = std::move(poolStats); break;
        case stride::ContactType::Id::Workplace: m_workplace = std::move(poolStats); break;
        case stride::ContactType::Id::PrimaryCommunity: m_prim_com = std::move(poolStats); break;
        case stride::ContactType::Id::SecondaryCommunity: m_sec_com = std::move(poolStats); break;
        case stride::ContactType::Id::Daycare: m_daycare = std::move(poolStats); break;
        case stride::ContactType::Id::PreSchool: m_preschool = std::move(poolStats); break;
        }
}
