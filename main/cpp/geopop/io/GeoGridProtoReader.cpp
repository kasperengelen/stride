...
shared_ptr<SimLocation> GeoGridProtoReader::ParseLocation(const proto::GeoGrid_Location& protoLocation)
{
        ...
        auto loc = make_shared<SimLocation>(id, province, coordinate, name, population);
