...
\paragraph{} Here we determine whether or not the age distribution of a population has an effect on the likeliness of an outbreak. To accomplish this we have two different household files, one for population A and one for population B. For each population we ran multiple simulations with different parameters. 

\paragraph{} We found that the intial specified seeding rate of $0.002$ was too high, leading to an outbreak rate of 100\%. We then lowered to seed to $0.00000167$, leading to more useful results. We also changed the amount of days that are to be simulated to $500$, since the effect of the epidemic is not very clear after $50$ days.

\subsubsection{Population A}

\paragraph{} Population A is a population which is significantly younger than population B. We expected that the outbreak rate for this population is higher than that for population B.

\paragraph{} Initially we ran the simulation 100 times during 500 days with seeding rate equal to $0.002$.
...
\paragraph{} Lowering the seeding rate to $0.00000167$ and running the simulation $100$ times during $500$ days gave a better result. We determined that the percentage of outbreaks lies within the 95\% confidence interval $[0.7216, 0.8784]$ with a measured outbreak rate of $\overline{x_n} = 0.8$.
...
\paragraph{} In order to reduce the confidence interval, we ran the same simulation $500$ times, leading to a measured average of $\overline{x_n} = 0.794$ and a 95\% confidence interval of $[0.75855, 0.82945]$.
...
\paragraph{} Population B is a population which is significantly older than population A. We expected that the outbreak rate for this population is lower than that for population A.
...
\paragraph{} Lowering the seeding rate to $0.00000167$ and running the simulation $100$ times during $500$ days gave a better result. We determined that the percentage of outbreaks lies within the 95\% confidence interval $[0.58871, 0.77143]$ with a measured outbreak rate of $\overline{x_n} = 0.68$.
...
\paragraph{} In order to reduce the confidence interval, we ran the same simulation $500$ times, leading to a measured average of $\overline{x_n} = 0.772$ and a 95\% confidence interval of $[0.73523, 0.80877]$.
