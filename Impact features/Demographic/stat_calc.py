...
csv_list = [
#    ["./count1000/RegionA_SR=0.002_Monday_Days=50_Cnt=1000.csv",      5000 ],
#    ["./count1000/RegionA_SR=0.002_Monday_Days=300_Cnt=1000.csv",     5000 ],
#    ["./count1000/RegionA_SR=0.00000167_Monday_Days=300_Cnt=1000.csv",40000],
#    ["./count1000/RegionB_SR=0.002_Monday_Days=50_Cnt=1000.csv",      5000 ],
#    ["./count1000/RegionB_SR=0.002_Monday_Days=300_Cnt=1000.csv",     5000 ],
#    ["./count1000/RegionB_SR=0.00000167_Monday_Days=300_Cnt=1000.csv",40000],
    ["./data/popOG.csv", 5000],
    ["./data/popNEW.csv", 5000]
]
